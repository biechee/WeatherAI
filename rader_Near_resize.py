...
# 输入文件夹和输出文件夹路径
input_folder = '/home/aclab/Biechee/UNET/Main_Use/data/band_rader_Near_size/rader_origin'
output_folder = '/home/aclab/Biechee/UNET/Main_Use/data/band_rader_Near_size/train/label'
...
for file_name in tqdm(file_list):
    ...
    if file_name.endswith('.png'):
        ...
        rader_extent = [118.0, 124.0, 20.5, 26.5]  # 雷达图像的经纬度范围
        ax.set_extent(rader_extent)

        # 调整Figure的大小以匹配合并后的图像大小
        fig = plt.gcf()
        fig.set_size_inches(301 / 100, 301 / 100)
        ...
        # 从数组中创建图像并调整大小
        new_rader_image = Image.fromarray((rader_image * 255).astype('uint8')).resize((301, 301))
