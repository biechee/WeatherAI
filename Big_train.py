...
from utils.Big_dataset import RASA_Loader
...
def train_net(net, device, data_path, val_data_path, epochs=50, batch_size=2, lr=0.00001):
    # 加载训练集
    ...
    for epoch in tqdm(range(epochs)):
        ...
        running_loss = 0.0
        # 按照batch_size开始训练
        for bands, label in train_loader:
            # print(label.shape)
            # print(bands.shape)
            # time.wait(21)
            # _ = input()
    ...
    plt.grid(True)
    # 設定圖片儲存路徑和檔名
    save_path = '/home/aclab/Biechee/UNET/Main_Use/Big_loss_plot.png'  # 指定儲存路徑和檔名
...
if __name__ == "__main__":
    ...
    # 指定训练集地址，开始训练
    data_path = "/home/aclab/Biechee/UNET/Main_Use/data/band_rader_Big_size/train"
    val_data_path = "/home/aclab/Biechee/UNET/Main_Use/data/band_rader_Big_size/val"
    #查看當前資料夾
    # print(os.getcwd())
