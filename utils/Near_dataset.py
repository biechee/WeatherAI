...
class RASA_Loader(Dataset):
    ...
    def extract_color(self, image):
        # 定义颜色映射
        colors_hex = [
            "#07FDFD", "#0695FD", "#0203F9", "#00FF00", "#00C800",
            "#019500", "#FEFD02", "#FEC801", "#FD7A00", "#FB0100",
            "#C70100", "#950100", "#FA03FA", "#9800F6", "#000000"
        ]
        ...
        # 对图像的每个像素应用颜色替换
        for i in range(new_image_data.shape[0]):
            for j in range(new_image_data.shape[1]):
                new_image_data[i, j] = self.find_nearest_color(image_data[i, j], colors_array)
